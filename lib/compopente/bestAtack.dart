...
class BestAtack extends StatefulWidget {
  int length;
  BestAtack(this.length);

  @override
  State<BestAtack> createState() => _BestAtackState();
}

class _BestAtackState extends State<BestAtack> {
  List<Teams> teams = [];
  @override
  void initState() {
    super.initState();
                        ...
                        child: Container(
                          child: Center(
                            child: Text(
                              team.matchs == 0
                                  ? "0"
                                  : (team.GF / team.matchs).toStringAsFixed(1),
                              style: TextStyle(
                                  fontSize: 12, color: MyColors.firsteColor),
                            ),
                          ),
